...
Version 0.4.1. The skill is portable text with an optional Python 3.10+ helper for POSIX systems. Claude Code and Codex interactive installation behavior must be verified in the user's runtime; repository-level pilots do not establish identical runtime behavior.
